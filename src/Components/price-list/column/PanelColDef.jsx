...
export const getPanelColDef = ({ onPanelEdit, onPanelDelete }) => {
  const panelDefCols = [
    {
      accessorKey: "id",
    ...
    //     return <div className="text-center font-medium">{created_at}</div>;
    //   },
    // },
    {
      id: "actions",
      cell: ({ row }) => {
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="bg-dark-surface-mixed-300 border-none shadow-lg rounded-[4px] z-[100] bg-white"
            >
              <DropdownMenuLabel>Actions</DropdownMenuLabel>

              <DropdownMenuItem className="hover:bg-orange-primary hover:bg-opacity-5 cursor-pointer">
                <div
