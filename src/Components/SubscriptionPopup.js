...
const SubscriptionPopup = ({ onSubscribe, onClose }) => {
  return (
    <div className="popup-subscription-overlay">
      <div className="popup-subscription-content">
        <button className="popup-close-icon" onClick={onClose}>
          <IonIcon icon={closeOutline} />
        </button>
        <h2 className="popup-title">Unlock Premium Features</h2>
        <p className="popup-description">
          Join our Basic Subscription plan for just{" "}
          <strong>$50 per month</strong> and enjoy the following benefits:
        </p>
        <ul className="popup-benefits">
          <li>
            ✔ Access up to <strong>50 exclusive leads</strong> every month.
          </li>
          <li>
            ✔ Showcase up to <strong>3 packages</strong> to potential buyers.
          </li>
        ...
        <p className="popup-footer-text">
          Don't miss this opportunity to grow your business! Subscribe now and
